...
describe('getSubscriptionByTopic()', () => {
  it('should return undefined if the supplied topic is not found', () => {
    ...
    const result = getSubscriptionByTopic((conn as unknown) as Connection, 'the wrong topic')
  ...
  it('should return a subscription object if the path is a match', () => {
    ...
    const result = getSubscriptionByTopic((conn as unknown) as Connection, 'the right topic')
